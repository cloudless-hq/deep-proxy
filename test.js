...
const testArray = ['monkeys', 12, { name: 'LeChuck', age: 999, pirate: true }]
...
// test('[10] if access of property, callbck is called with path [0]', t => {
//   t.plan(2)
//   const proxy = setup(testArray, (path, value) => {
//     t.deepEqual(path, ['0'])
//     t.is(value, 'monkeys')
//   })
//   proxy['0$'] === undefined
...
// test('[11] if access of property, callbck is called with path [5]', t => {
//   t.plan(2)
//   const proxy = setup(testArray, (path, value) => {
//     t.deepEqual(path, ['5'])
//     t.is(value, undefined)
...
// test('[12] if access of property, callbck is called with path [0][1]', t => {
//   t.plan(2)
//   const proxy = setup(testArray, (path, value) => {
